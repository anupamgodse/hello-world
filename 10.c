...
int recurse = 0, omitfirst = 0, nopromt = 0, delete = 0, exempty = 0, showsize = 0, sameline = 0, nohidden = 0, summarize = 0;

int main(int argc, char **argv) {
	int opt;
	
	while ((opt = getopt_long(argc, argv, "frdnS1NAm", long_options, NULL)) != EOF) {
   		 switch (opt) {
    			case 'f':
      			omitfirst = 1;
      			break;
